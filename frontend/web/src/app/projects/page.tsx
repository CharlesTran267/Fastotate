...
export default function ProjectsPage() {
    ...
    const [projectNameInput, setProjectNameInput] = useState<string | null>(
        null,
    );
    ...
    const handleSaveNewProjectName = async (project_id: string) => {
        await userSessionActions.changeProjectName(
            project_id,
            projectNameInput!,
        );
        await fetchProjects();
        ...
        <div className="h-full w-full">
            {!projects || projects.length === 0 ? (
                <div className="flex h-full flex-col items-center justify-center">
                    <h2 className="my-6 text-xl font-black">
                        No Projects found!
                    </h2>
                    <button
                        ...
                        {currentPageProjects.map((project: ProjectSummary) => (
                            <div className="w-100 card mb-auto bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        Default Class: {project.default_class}
                                    </p>
