...
export default function Canvas() {
    ...
    const dragBoundFunc = (pos) => {
        ...
        if (stageWidth > frameWidth) {
            if (newX < -(stageWidth - frameWidth))
                newX = -(stageWidth - frameWidth);
        } else {
                    ...
                    {selectedImage != null ? (
                        <>
                            ...
                            >
                                ...
                                >
                                    <Image
                                        ...
                                        onClick={() =>
                                            sessionActions.setSelectedAnnotationID(
                                                null,
                                            )
                                        }
                                    />
                            ...
                            <div className="float-end my-4">
                                <p>
                                    X: {Math.round(mousePosOri[0] * 100) / 100},
                                    Y: {Math.round(mousePosOri[1] * 100) / 100}
                                </p>
                            </div>
                        </>
                    ) : null}
