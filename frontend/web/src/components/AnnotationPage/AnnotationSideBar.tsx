...
export default function AnnotationSideBar() {
  ...
  return (
    <aside className="w-18 flex h-screen flex-col bg-base-100 py-6 text-neutral">
      <div className="flex flex-1 flex-col justify-center">
        <div className="tooltip tooltip-right" data-tip="Select (s)">
          <button
            ...
            style={{ backgroundColor: annotationMode === AnnotationMode.SELECT ? 'var(--fallback-bc,oklch(var(--bc)/0.2))' : '' }}
          >
        ...
        <div className="tooltip tooltip-right" data-tip="Polygon (p)">
          <button
            ...
            style={{ backgroundColor: annotationMode === AnnotationMode.POLYGON ? 'var(--fallback-bc,oklch(var(--bc)/0.2))' : '' }}
          >
        ...
        <div className="tooltip tooltip-right" data-tip="Rectangle (r)">
          <button
            ...
            style={{ backgroundColor: annotationMode === AnnotationMode.RECTANGLE ? 'var(--fallback-bc,oklch(var(--bc)/0.2))' : '' }}
          >
